...
/*---- Google Map ----*/
	...
	function initialize() {
		...
		var secheltLoc = new google.maps.LatLng(46.347061, 47.992887);
		...
		var marker = new google.maps.Marker({
			map: theMap,
			draggable: false,
			position: new google.maps.LatLng(46.347061, 47.992887),
			icon: image,
			visible: true
		});
		...
		var contentString = '<div id="content-boolean">'+
	      '<h1>ООО "АДМИРАЛ"</h1>'+
	      '<p>Россия, г.Астрахань ул. Медногорская, д.79 , инд.414006</p>'+
	      '</div>';
